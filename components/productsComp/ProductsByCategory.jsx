        ...
        filteredProducts.map((product) => (
          <div onClick={() => handleCategoryClick(product._id)}>
            <CardContainer className="inter-var">
              <CardBody
                key={product._id}
                className="sm:h-[35rem] sm:w-[19rem] h-[23rem] w-[13rem] border-2 rounded-xl p-3 relative group transition-all duration-300 ease-in-out hover:scale-110 shadow-xl cursor-pointer bg-gray-100"
